...
{-|
Covalent radii of elements in Angstrom taken from <https://en.wikipedia.org/wiki/Covalent_radius
Wikipedia>
-}
...
covalentRadiiIM = IM.fromList listOfPairs
  where listOfPairs = Map.toList $ Map.mapKeys ((+ 1) . fromEnum) covalentRadii
